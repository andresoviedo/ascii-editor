...
class ASCIICanvas {
	...
	constructor(htmlCanvas: HTMLCanvasElement, grid: Grid) {
	...
	getWidth() { return this.getCanvasHTML().width }
	getGrid () { return this.grid }
	getCellWidth () { return this.cellWidth }
	getCellHeight () { return this.cellHeight }
	getZoom () { return this.zoom }
	setZoom(newZoom: number) { this.zoom = newZoom }
	getCanvasHTML () { return this.canvasHTML }
	getCanvasContext () { return this.canvasContext }
	isFocused (){
  ...
  drawText(text: string, coord: Coord, style: string) {
	...
	mouseDown (eventObject:unknown) {	}
	mouseMove(eventObject:unknown) {	}
	mouseUp() {	}
	mouseEnter() { }
	cellDown(coord:Coord) {
		this.startCoord = coord;
	}
	cellMove(coord:unknown) { }
	cellUp(coord:unknown) { }
	mouseLeave() { }
	keyUp(eventObject:unknown){ }
